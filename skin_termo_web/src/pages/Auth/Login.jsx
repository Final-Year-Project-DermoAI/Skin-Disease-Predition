    ...
    <div style={{ 
      ...
      <div className="glass-card animate-fade-up" style={{ width: '100%', maxWidth: '480px', padding: '48px' }}>
        ...
        <div style={{ marginTop: '40px', textAlign: 'center', borderTop: '1px solid var(--border)', paddingTop: '32px' }}>
          <div style={{ marginBottom: '24px' }}>
            <p style={{ color: 'var(--text-dim)', fontSize: '13px', marginBottom: '16px', fontWeight: '600', letterSpacing: '0.5px' }}>ARE YOU A MEDICAL PROFESSIONAL?</p>
            <button 
            ...
            >
              <ShieldCheck size={18} /> REGISTER AS DOCTOR
            </button>
          </div>
          
          <p style={{ color: 'var(--text-dim)', fontSize: '14px' }}>
            New to the platform? <Link to="/signup" className="premium-gradient-text" style={{ textDecoration: 'none', fontWeight: '700' }}>Create Patient Account</Link>
          </p>
