            ...
            <tr key={user.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.02)' }}>
              <td style={{ padding: '16px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                   ...
                   <div>
                     <p style={{ margin: 0, fontWeight: 'bold', fontSize: '14px' }}>{user.firstName} {user.lastName}</p>
              ...
              <td style={{ padding: '16px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '13px' }}>
                   <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: user.isVerified ? '#00e676' : '#ffd600' }}></div>
                   <span style={{ color: user.isVerified ? '#00e676' : '#ffd600', fontWeight: '500' }}>{user.isVerified ? 'Verified' : 'Pending'}</span>
                </div>
              </td>
              <td style={{ padding: '16px' }}>
                <button 
...
const SystemConfig = () => (
  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '24px' }}>
     <div className="glass-card" style={{ padding: '32px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        {[
          { label: 'Primary Backend', value: 'http://localhost:3000', type: 'REST' },
