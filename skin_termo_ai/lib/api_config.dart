...
class ApiConfig {
  ...
  static const String defaultHost = 'http://10.0.2.2:11434'; // Better default for development
  static const String defaultBackendHost = 'http://10.0.2.2:3000';
  ...
  static Future<String> getBackendHost() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString(_backendHostKey) ?? defaultBackendHost;
  }
